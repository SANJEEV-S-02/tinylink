...
export default function ShortLinkTable() {
  ...
  return _jsxs('div', {
    ...
    children: [
      _jsx('div', {
        className:
          'mb-5 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 lg:mb-7',
        children: _jsx('h3', {
          className: 'text-lg font-semibold text-gray-800',
          children: 'Your Short Links',
        }),
      }),
      _jsx('div', {
        className:
                ...
                children: _jsxs(TableRow, {
                  children: [
                    ...
                    _jsx(TableCell, {
                      isHeader: true,
                      className:
                        'px-5 py-3 font-medium text-gray-500 text-center',
                      children: 'Clicks',
                    }),
                    _jsx(TableCell, {
                      isHeader: true,
                      ...
                      _jsxs(
                        TableRow,
                        {
                          children: [
                            ...
                            _jsx(TableCell, {
                              className:
                                'px-5 py-4 max-w-xs truncate text-gray-600',
                              children: link.url,
                            }),
                            _jsx(TableCell, {
                              className:
                                'px-5 py-4 text-center font-semibold text-gray-700',
                            ...
                            _jsx(TableCell, {
                              ...
                              children: _jsx(ActionDropdown, {
                                code: link.code,
                                onCopy: () => handleCopy(link.code),
                                onStats: () =>
                                  (window.location.href = `/code/${link.code}`),
                                onDelete: () => openDeleteModal(link.code),
                              }),
                            }),
                          ],
                        },
              ...
              _jsxs('div', {
                ...
                children: [
                  _jsx('button', {
                    ...
                    className:
                      'flex items-center gap-2 rounded-2xl border border-gray-300 bg-[#F8C723] px-10 py-2 text-sm font-medium text-gray-700',
                    children: 'Yes, Delete',
                  }),
                  _jsx('button', {
                    onClick: closeDeleteModal,
                    className:
                      'px-4 py-2 rounded-2xl border border-[#F8C723] text-gray-800',
                    children: _jsx(X, {
                      size: 18,
                      className: 'text-[#F8C723]',
                    }),
                  }),
                ],
              }),
      ...
      isOpen &&
        createPortal(
          _jsx('div', {
            ref: dropdownRef,
            className:
              'absolute z-[9999] w-[200px] rounded-2xl border border-gray-200 bg-white p-3 shadow-xl',
            style: {
              ...
              children: [
                _jsx('li', {
                  children: _jsx('button', {
                    onClick: onCopy,
                    className:
                      'w-full text-left px-3 py-2 text-gray-500 rounded-lg hover:bg-gray-100',
                    children: 'Copy',
                  }),
                }),
                _jsx('li', {
                  children: _jsx('button', {
                    onClick: onDelete,
                    className:
                      'w-full text-left px-3 py-2 text-red-500 rounded-lg hover:bg-gray-100',
                    children: 'Delete',
                  }),
                }),
              ],
